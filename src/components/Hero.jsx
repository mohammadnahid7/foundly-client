...
const Hero = () => {
	return (
		<>
			<>
				<header className="relative h-[90vh] md:h-[70vh] bg-[url('https://images.pexels.com/photos/255379/pexels-photo-255379.jpeg?cs=srgb&dl=pexels-padrinan-255379.jpg&fm=jpg')] bg-cover">
					...
					<div className="relative max-w-7x h-full z-[1] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8 flex flex-col justify-center">
						...
						<div className="text-center space-y-2 sm:space-x-5">
							<Link
